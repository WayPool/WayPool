...
import { SimpleEthereumConnector } from './SimpleEthereumConnector';
import { useToast } from '@/hooks/use-toast';
import { Alert, AlertDescription, AlertTitle } from "@/components/ui/alert";
import { Info } from "lucide-react";

interface EnhancedMultiBlockchainConnectorProps {
  defaultTab?: 'ethereum' | 'monero' | 'solana' | 'bitcoin';
  showDescription?: boolean;
}

export function EnhancedMultiBlockchainConnector({
  defaultTab = 'ethereum',
  showDescription = true
}: EnhancedMultiBlockchainConnectorProps) {
      ...
      <CardContent>
        ...
        >
          ...
          <TabsContent value="ethereum" className="mt-4 space-y-4">
            <SimpleEthereumConnector onConnect={handleEthereumConnect} />
